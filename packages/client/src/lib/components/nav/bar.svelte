<script lang="ts">
	...
	// Update scrollY when window scrolls
	$effect(() => {
...
<div
	class="nav fixed left-0 right-0 top-0 flex w-full items-center justify-between bg-opacity-50 p-2 transition-all duration-200"
